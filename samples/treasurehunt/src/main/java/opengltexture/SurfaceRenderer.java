...
public class SurfaceRenderer implements GLSurfaceView.Renderer {
     ...
     */
    public SurfaceRenderer(final Context activityContext) {
    ...
    public void onSurfaceCreated(GL10 glUnused, EGLConfig config) {
        ...
        // Load the texture
        mTextureDataHandle = TextureHelper.loadTexture(mActivityContext, mBitmap);//R.drawable.ad);
        //R.drawable.bumpy_bricks_public_domain);
    }

    public void updateTextureDataHandle(Bitmap bitmap) {
